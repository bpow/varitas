varitas.snpEffSplitter()
varitas.geneAnnotator("in_omim", "data/omimgenes")
varitas.geneAnnotator("in_hgmd", "data/hgmdgenes")
varitas.geneAnnotator("in_cosmic", "data/cosmicgenes")
varitas.geneAnnotator("in_genetests", "data/genetestsgenes")
...
varitas.vcfAnnotator("data/ESP6500SI-V2.vcf.gz",
    "MAF=ESPMAF,GTS,EA_GTC,AA_GTC,FG,GM,AA,AAC,PP,CDP,CG,GS,CA,DP=ESPDP,GL=ESPGL")
varitas.tsvAnnotator("data/dbNSFP2.4_variant.gz",
